...
def license_plate(img_path='D:\Desktop\ECE\Machine vision and Intelligent systems\Projects\project 1\vehicle plate\c2.jpg'):
    ...
    for i in contours:
        ...
        if w > h * 1.2:
            lcs_oblique = img_path[y:y + h, x:x + w - 5]
...
def backgroud_checking(img_path):
...
def preprocess(img_path):
    img_bgr = cv2.resize(img_path, (int(200*img_path.shape[1]/img_path.shape[0]), 200))
...
if __name__ == '__main__':
    img_bgr = cv2.imread('D:\Desktop\ECE\Machine vision and Intelligent systems\Projects\project 1\CCPD2020\CCPD2020\ccpd_green\test\01-90_265-231&522_405&574-405&571_235&574_231&523_403&522-0_0_3_1_28_29_30_30-134-56.jpg')
